...
if __name__ == "__main__":
    ...
    print("\t\t\t\t\t\t\t♦♦♦♦♦♦♦ WELCOME TO THE Nikhil's LIBRARY ♦♦♦♦♦♦♦\n")
    ...
    while (True):
        ...
        try:
            ...
            if usr_response == 1:  # listing
                NikhilLib.displayAvailableBooks()
            elif usr_response == 2:  # borrow
                NikhilLib.borrowBook(
                    input("Enter your name: "), student.requestBook())
            elif usr_response == 3:  # return
                NikhilLib.returnBook(student.returnBook())
            elif usr_response == 4:  # donate
                NikhilLib.donateBook(student.donateBook())
